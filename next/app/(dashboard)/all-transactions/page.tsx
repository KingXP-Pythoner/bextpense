...
export default async function AllTransactionsPage({ searchParams }: AllTransactionsPageProps) {
  const awaitedSearchParams = await searchParams
  const parsedSearchParams = transactionSearchParamsCache.parse(awaitedSearchParams)
      ...
      <TransactionsTable 
        initialData={initialData.transactions.map((t) => {
          ...
          const transaction = {
            ...
            updatedAt: typeof t.updatedAt === 'string' 
              ? t.updatedAt 
