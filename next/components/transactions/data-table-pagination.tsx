...
import { DEFAULT_PER_PAGE_MAX, DEFAULT_PER_PAGE_MIN } from "@/constants/transaction"
...
export function DataTablePagination<TData>({ table, pageSizeOptions = [10, 20, 30] }: DataTablePaginationProps<TData>) {
