...
type ChartDataKey = Extract<
	keyof TTransactionOverviewResponse,
	"recurringRevenue" | "recurringExpenses" | "savings"
>;
...
export const ChartDataNumber = ({ title, ...props }: ChartDataNumberProps) => {
	...
	const dataKey =
		chartTitleToDataKey[title as keyof typeof chartTitleToDataKey] ??
		"recurringRevenue";
...
export const ChartGrowthPercentage = ({
	title,
	isExpense = false,
	...props
