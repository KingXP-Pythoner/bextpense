...
import { updateTransactionSchema, UpdateTransactionSchema } from '@/schemas/transactions';
...
const EditTransactionForm = ({ transaction, onSuccess }: { 
  transaction: TTransaction & {
    transactionDate: string;
    createdAt: string;
    updatedAt: string;
  ...
  const { executeAsync: updateTransaction, } = useAction(updateTransactionAction, {
    onSuccess: (data) => {
    ...
    return (
        <div>
            <Form {...form}>
                <form id='edit-transaction-form' onSubmit={form.handleSubmit(updateTransaction)} className='space-y-4'>
                    <FormField
...
export const EditTransactionDialog = ({ transaction }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle className='font-medium text-lg'>Edit transaction</DialogTitle>
          ...
          <DialogFooter>
            ...
            <Button type='submit' form='edit-transaction-form'>Update</Button>
          </DialogFooter>
        </DialogContent>
    </Dialog>       
  )
